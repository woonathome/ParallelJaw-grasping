...
def get_test_data(rgb_path = '', depth_path = '', cam_path = cam_path, cad_path = cad_path, seg_path = seg_path, det_score_thresh = det_score_thresh, cfg = None, scene_id = SCENE_ID, N_INSTANCE = 10): # RTX 5070 laptop GPU 메모리 기준: N_INSTANCE=30
    dets = []
...
def PEM_run_save(model = None, cfg = None, save_img = True, tag='default'):
    ...
    R_best = pred_rot[best_idx]      # shape: (3,3) 또는 (9,) or (4,4) 
